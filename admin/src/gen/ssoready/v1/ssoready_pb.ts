...
export class SCIMUser extends Message<SCIMUser> {
   ...
   *
   * @generated from field: repeated ssoready.v1.SCIMGroupRef groups = 6;
   */
  groups: SCIMGroupRef[] = [];
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 6, name: "groups", kind: "message", T: SCIMGroupRef, repeated: true },
  ]);
...
/**
 * @generated from message ssoready.v1.SCIMGroupRef
 */
export class SCIMGroupRef extends Message<SCIMGroupRef> {
  /**
   * The SCIM group ID.
   *
   * @generated from field: string id = 1;
  ...
  constructor(data?: PartialMessage<SCIMGroupRef>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ssoready.v1.SCIMGroupRef";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "display_name", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): SCIMGroupRef {
    return new SCIMGroupRef().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): SCIMGroupRef {
    return new SCIMGroupRef().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): SCIMGroupRef {
    return new SCIMGroupRef().fromJsonString(jsonString, options);
  }

  static equals(a: SCIMGroupRef | PlainMessage<SCIMGroupRef> | undefined, b: SCIMGroupRef | PlainMessage<SCIMGroupRef> | undefined): boolean {
    return proto3.util.equals(SCIMGroupRef, a, b);
  }
}
