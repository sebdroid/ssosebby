...
const (
	...
	// SSOReadyServiceCheckEnvironmentCustomDomainSettingsCertificatesProcedure is the fully-qualified
	// name of the SSOReadyService's CheckEnvironmentCustomDomainSettingsCertificates RPC.
	SSOReadyServiceCheckEnvironmentCustomDomainSettingsCertificatesProcedure = "/ssoready.v1.SSOReadyService/CheckEnvironmentCustomDomainSettingsCertificates"
	...
	// SSOReadyServiceAppDeleteOrganizationProcedure is the fully-qualified name of the
	// SSOReadyService's AppDeleteOrganization RPC.
	SSOReadyServiceAppDeleteOrganizationProcedure = "/ssoready.v1.SSOReadyService/AppDeleteOrganization"
...
type SSOReadyServiceClient interface {
	...
	CheckEnvironmentCustomDomainSettingsCertificates(context.Context, *connect.Request[v1.CheckEnvironmentCustomDomainSettingsCertificatesRequest]) (*connect.Response[v1.CheckEnvironmentCustomDomainSettingsCertificatesResponse], error)
	...
	AppDeleteOrganization(context.Context, *connect.Request[v1.AppDeleteOrganizationRequest]) (*connect.Response[emptypb.Empty], error)
...
func NewSSOReadyServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) SSOReadyServiceClient {
	...
	return &sSOReadyServiceClient{
		...
		checkEnvironmentCustomDomainSettingsCertificates: connect.NewClient[v1.CheckEnvironmentCustomDomainSettingsCertificatesRequest, v1.CheckEnvironmentCustomDomainSettingsCertificatesResponse](
			httpClient,
			baseURL+SSOReadyServiceCheckEnvironmentCustomDomainSettingsCertificatesProcedure,
			opts...,
		),
		...
		appDeleteOrganization: connect.NewClient[v1.AppDeleteOrganizationRequest, emptypb.Empty](
			httpClient,
			baseURL+SSOReadyServiceAppDeleteOrganizationProcedure,
			opts...,
		),
...
type sSOReadyServiceClient struct {
	...
	checkEnvironmentCustomDomainSettingsCertificates *connect.Client[v1.CheckEnvironmentCustomDomainSettingsCertificatesRequest, v1.CheckEnvironmentCustomDomainSettingsCertificatesResponse]
	...
	appDeleteOrganization                            *connect.Client[v1.AppDeleteOrganizationRequest, emptypb.Empty]
...
// CheckEnvironmentCustomDomainSettingsCertificates calls
// ssoready.v1.SSOReadyService.CheckEnvironmentCustomDomainSettingsCertificates.
func (c *sSOReadyServiceClient) CheckEnvironmentCustomDomainSettingsCertificates(ctx context.Context, req *connect.Request[v1.CheckEnvironmentCustomDomainSettingsCertificatesRequest]) (*connect.Response[v1.CheckEnvironmentCustomDomainSettingsCertificatesResponse], error) {
	return c.checkEnvironmentCustomDomainSettingsCertificates.CallUnary(ctx, req)
}
...
// AppDeleteOrganization calls ssoready.v1.SSOReadyService.AppDeleteOrganization.
func (c *sSOReadyServiceClient) AppDeleteOrganization(ctx context.Context, req *connect.Request[v1.AppDeleteOrganizationRequest]) (*connect.Response[emptypb.Empty], error) {
	return c.appDeleteOrganization.CallUnary(ctx, req)
}
...
func NewSSOReadyServiceHandler(svc SSOReadyServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	sSOReadyServiceCheckEnvironmentCustomDomainSettingsCertificatesHandler := connect.NewUnaryHandler(
		SSOReadyServiceCheckEnvironmentCustomDomainSettingsCertificatesProcedure,
		svc.CheckEnvironmentCustomDomainSettingsCertificates,
		opts...,
	)
	...
	sSOReadyServiceAppDeleteOrganizationHandler := connect.NewUnaryHandler(
		SSOReadyServiceAppDeleteOrganizationProcedure,
		svc.AppDeleteOrganization,
		opts...,
	)
	...
	return "/ssoready.v1.SSOReadyService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		case SSOReadyServiceCheckEnvironmentCustomDomainSettingsCertificatesProcedure:
			sSOReadyServiceCheckEnvironmentCustomDomainSettingsCertificatesHandler.ServeHTTP(w, r)
		...
		case SSOReadyServiceAppDeleteOrganizationProcedure:
			sSOReadyServiceAppDeleteOrganizationHandler.ServeHTTP(w, r)
...
func (UnimplementedSSOReadyServiceHandler) CheckEnvironmentCustomDomainSettingsCertificates(context.Context, *connect.Request[v1.CheckEnvironmentCustomDomainSettingsCertificatesRequest]) (*connect.Response[v1.CheckEnvironmentCustomDomainSettingsCertificatesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("ssoready.v1.SSOReadyService.CheckEnvironmentCustomDomainSettingsCertificates is not implemented"))
}
...
func (UnimplementedSSOReadyServiceHandler) AppDeleteOrganization(context.Context, *connect.Request[v1.AppDeleteOrganizationRequest]) (*connect.Response[emptypb.Empty], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("ssoready.v1.SSOReadyService.AppDeleteOrganization is not implemented"))
}
